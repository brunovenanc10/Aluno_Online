...
Adicionar neste README:

- prints das requisicoes no Insomnia para aluno e professor
- prints do DBeaver mostrando as tabelas `alunos` e `professores`
...
Enviar somente o link do repositorio no GitHub.
